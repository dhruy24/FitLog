  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2">
      <input
        ...
        min="1"
        required
        className="flex-1 px-3 py-2 border border-zinc-300 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-zinc-500 dark:focus:ring-zinc-400"
      />
      <input
        type="number"
